...
POINT_MODULE_VERSION = "0.23.00"
POINT_API_PORT = 17892
POINT_API_HEADER = "X-ALIYVO-Ponto"
POINT_API_SECRET = "aliyvo-ponto-02300"
...
class AliyvoPontoController(QObject):
    ...
    def __init__(self, owner: QWidget, nav_button: QPushButton | None = None):
        ...
        self._log_file = _base_dir() / "logs" / "DIAGNOSTICO_PONTO_02300.jsonl"
    ...
    def _send_ahgora_chrome_hotkey(self) -> bool:
        """Ativa Chrome e envia Ctrl+Shift+9, configurado pelo usuário para a extensão Ahgora."""
        if os.name != "nt":
            return False
        ...
        try:
            ...
            user32.keybd_event(VK_9, 0, 0, 0)
            user32.keybd_event(VK_9, 0, KEYEVENTF_KEYUP, 0)
        ...
        def trigger():
            if not self._send_ahgora_chrome_hotkey():
                ...
                QMessageBox.warning(
                    ...
                    "Não consegui localizar uma janela do Google Chrome.\n\n"
                    "Abra o Chrome e tente novamente. O atalho configurado deve ser Ctrl+Shift+9.",
                )
                return
    ...
    def _start_api(self) -> None:
        ...
        class Handler(BaseHTTPRequestHandler):
            server_version = "ALIYVO-Ponto/0.23.00"
